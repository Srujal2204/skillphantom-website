...
export default function AboutClient() {
  ...
  const team = [
    { name: "Janvi Raj", role: "Managing Director", img: "/team/janvi.jpg", portfolio: "/Janvi" },
    { name: "Aarti Kesariya", role: "Managing Director", img: "/team/aarti.jpg", portfolio: "/Aarti" },
    { name: "Mukesh Talpada", role: "Technical Lead", img: "/team/mukesh.jpg", portfolio: "/Mukesh" }
  ];
  ...
  return (
    <>
      ...
      <main className={`bg-[#050505] text-white min-h-screen ${inter.className} relative overflow-hidden`}>
        ...
        <section className="relative z-10 py-24 px-6 max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white/[0.03] border border-white/5 p-12 rounded-[4rem] hover:bg-white/[0.05] transition-all">
 ...
 {/* ================= FOUNDERS (HIGHLIGHTED) ================= */}
            ...
            {founders.map((f, i) => (
              ...
              >
                <div className="bg-[#080808] rounded-[3.8rem] p-10 h-full border border-white/5">
                  <img src={f.img} className="w-full h-80 object-cover rounded-[3rem] mb-10 grayscale hover:grayscale-0 transition-all duration-700" alt={f.name} />
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {team.map((m, i) => (
              <Link href={m.portfolio} key={i} className="group">
                <div className="flex items-center gap-6 p-6 bg-white/[0.02] border border-white/5 rounded-[2.5rem] group-hover:bg-white/[0.05] transition-all group-hover:border-blue-500/30">
        ...
        <footer className="relative z-10 py-40 text-center border-t border-white/5">
          <h2 className={`${outfit.className} text-4xl font-bold text-gray-800 mb-8`}>Skill over Degree.</h2>
